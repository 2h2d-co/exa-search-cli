#!/usr/bin/env node
import { CliError, formatResponse, helpText, parseCli, searchJson, streamSearch, VERSION, } from "./core.js";
async function main() {
    try {
        ...
        process.stdout.write(`${formatResponse(response, command.options.format, command.options.compact)}\n`);
    }
    catch (error) {
